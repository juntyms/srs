...
class softwareRequest extends FormRequest
{
    ...
    {
        return [    'ay_id'=>'required','department_id'=>'required','name'=>['required','min:5'],'software_vendor_id'=>'required',
                    'software_type_id'=>'required','company_id'=>'required','purchase_date'=>'required','price'=>'required',
                    'expiry_date'=>'required','warranty_end_date'=>'required','license_id'=>'required','installer_is_available'=>'required',
                    'custodian_name'=>['required','min:5']
        ];
    }
    ...
    public function messages()
    {
        return ['ay_id.required'=>'Academic Year can not be blank',
                ...
                'name.min'=>'Software name must be at least 5 characters',
                ...
                'price.required'=>'Software Price can not be blank',
                ...
                'custodian_name.min'=>'Custodian name must be at least 5 characters'
                ];
    }
}
